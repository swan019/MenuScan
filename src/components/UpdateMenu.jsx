    ...
    return (
        <div className=' mx-auto my-8 max-w-screen-md rounded-md flex  justify-around items-center px-5 py-4 bg-slate-200'>
            <div className='bg-slate-600 px-6 py-4 rounded-md text-white'>
                <Dialog>
                    <DialogTrigger>Update <span className='text-red-400 font-semibold text-base'> { Item.name } </span>  Menu</DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                ...
                                />
                                <input
                                    type="text" placeholder='Price' name='halfPrice' value={formData.halfPrice} className='p-2 my-4 border rounded-sm mx-3'
                                    onChange={(e) => handleChange(e)}
                                />
                                <input
                                    type="text" placeholder='Price' name='fullPrice' value={formData.fullPrice} className='p-2 my-4 border rounded-sm mx-3'
                                    onChange={(e) => handleChange(e)}
                                />
                                <input
