  ...
  return (
    <div>
      ...
      <div className='flex flex-wrap'>
        <div className='flex justify-center rounded-md mx-auto py-8 items-center my-8'>
          <ResizablePanelGroup
            ...
            <ResizablePanel defaultSize={50}>
              <ResizablePanelGroup direction="vertical">
                ...
                <ResizablePanel defaultSize={75}>
                  <div className="flex flex-col flex-wrap gap-2 h-full items-center justify-center p-1">
                    {
        ...
        <div className='flex justify-center   rounded-md mx-auto py-6 items-center my-8'>
          <ResizablePanelGroup
            direction="horizontal"
            className=" rounded-lg border-[1.4px] border-slate-900 md:min-w-[350px]"
          >
            <ResizablePanel defaultSize={50}>
              <div className="flex bg-slate-700 text-xl text-white h-[200px] items-center justify-center p-1">
