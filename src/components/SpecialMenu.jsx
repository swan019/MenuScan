        ...
        <div className='flex justify-center  rounded-md mx-auto py-6 items-center my-8'>
          ...
          >
            ...
            <ResizablePanel defaultSize={50}>
              <ResizablePanelGroup direction="vertical">
                <ResizablePanel defaultSize={25}>
                  <div className="flex h-full items-center bg-slate-700 text-white justify-center">
                    <span className="font-semibold">Contact Us</span>
                  </div>
                </ResizablePanel>
                <ResizableHandle />
                <ResizablePanel defaultSize={75}>
                  <div className="flex flex-col flex-wrap gap-2 h-full items-center justify-center">
